 ...
 * plugins/YouNeedMe/expansions/}. Mirrors {@code JavaPlugin}'s own lifecycle on purpose so it
 * feels familiar: {@link #onLoad} happens once the jar is discovered and its class loaded,
 * {@link #onEnable} once every expansion has finished loading, {@link #onDisable} on server
 * shutdown or {@code /ynm reload}.
 *

...
/**
 * One shop entry. {@code buyPrice}/{@code sellPrice} of {@code null} disables that direction (an
 * item that can only be sold to the shop, or only bought from it). {@code stock} of {@code null}
 * means unlimited.
 */
